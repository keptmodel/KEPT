...
def get_train_args():
    ...
    parser.add_argument("--seed", type=int, default=40, help="random seed for initialization")
    ...
    parser.add_argument("--warmup_steps", default=0.2, type=float, help="Linear warmup over warmup_steps.")
    parser.add_argument("--codet5", default='../CodeT5',
                        help="codet5 model location ")
    parser.add_argument(
        "--fp16_opt_level",
        type=str,
        default="O1",
...
def init_train_env(args):
    ...
    config = T5Config.from_pretrained(args.codet5,local_files_only = True)
    
    model = CodeT5(config, args.codet5)
