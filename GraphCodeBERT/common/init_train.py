...
def get_train_args():
    ...
    parser.add_argument("--warmup_steps", default=0.05, type=float, help="Linear warmup over warmup_steps.")
    parser.add_argument("--gcbert", default='../gcbert',
...
def init_train_env(args):
    ...
    config = RobertaConfig.from_pretrained(args.gcbert,local_files_only=True)
    
    model = GCBert(config, args.gcbert)
