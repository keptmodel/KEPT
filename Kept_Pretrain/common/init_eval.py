...
from pretrain.common.init_train import load_examples
from pretrain.common.metrices import metrics

import torch
from transformers import BertConfig
from pretrain.common.models import Rapt
from pretrain.common.utils import MODEL_FNAME, results_to_df
...
def get_eval_args():
    ...
    parser.add_argument("--code_bert", default="/nvme2n1/LiYworks/RAPT/trace/codebert", help="the base bert")
