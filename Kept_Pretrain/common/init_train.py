...
from pretrain.common.utils import save_check_point, load_check_point, write_tensor_board, set_seed, evaluate_retrival, \
    evaluate_classification, format_batch_input
from pretrain.common.data_processing import CodeSearchNetReader
from pretrain.common.data_structures import Examples
from pretrain.common.models import  Rapt

logger = logging.getLogger(__name__)


def load_examples(data_dir, data_type, model, overwrite=False, num_limit=None,
...
def get_exp_name(args):
    ...
    print("---------------")
    return exp_name.format("Rapt", args.neg_sampling, time, base_model)
...
def train(args, train_examples, valid_examples, model, train_iter_method):
    ...
    step_bar = tqdm(initial=0, total=t_total, desc="Steps")
...
def get_train_args():
    ...
    parser.add_argument(
        "--data_dir", default="/nvme2n1/HuYworks/pretrain_bak/data/java", type=str,
    ...
    parser.add_argument(
        "--output_dir", default="/nvme2n1/HuYworks/pretrain_bak/rapt/output/model", type=str, required=False,
    ...
    parser.add_argument("--code_bert", default='/home/yueli/HuYworks1/unix_rat/trace/unixCoder',
                        help="Negative sampling strategy we apply for constructing dataset. ")
    parser.add_argument(
        "--fp16_opt_level",
        type=str,
