...
import miningChanges.ProduceChangeFileLevelResults;
import miningChanges.ProduceChangeHunkLevelResults;
...
public class Main {
	...
	public static void startTask() throws Exception {
		...
		if (task.equals("indexHunks")) {
			...
			ProduceChangeFileLevelResults rank2 = new ProduceChangeFileLevelResults();
			rank2.getFinalResults();
			ProduceChangeHunkLevelResults rank3 = new ProduceChangeHunkLevelResults();
			rank3.getFinalResults();
	...
	public static boolean loadConfigure(String filename) throws Exception {
		...
		if (task.equals("") || repoDir.equals("") || workingLoc.equals("")
				|| bugReport.equals("") || changeOracle.equals("") || projectName.equals("")
				|| versionName.equals("")) {
