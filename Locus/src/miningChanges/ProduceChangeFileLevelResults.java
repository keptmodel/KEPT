...
public class ProduceChangeFileLevelResults {
	...
	public boolean loadOracles() {
		String filename = loc + File.separator + "bugCommitFileIndex.txt";
...
//			System.out.println(lines.get(index));
	...
	public void loadResults() {
		...
		String resultFile = loc + File.separator + "results_changefile" + ".txt";
		File file = new File(resultFile);
		if (!file.exists()) {
			ObtainVSMScore ovs = new ObtainVSMScore();
			hunkResults = ovs.obtainSimilarity(true,ObtainVSMScore.ChangeLevel.file);
...
//				System.out.println(change + "\t" + revisionTime.get(change));
			...
			for (String file : inducingRevisions.get(bid)) {
		...
		System.out.println();
		String filename = main.Main.settings.get("workingLoc") + File.separator + "changeFileLevelResults.txt";
