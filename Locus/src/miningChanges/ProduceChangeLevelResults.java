...
public class ProduceChangeLevelResults {
	...
	public boolean loadOracles() {
		String filename = loc + File.separator + "bugCommitIndex.txt";
...
//			System.out.println(lines.get(index));
	...
	public void loadResults() {
		...
		String resultFile = loc + File.separator + "results_changecommit" + ".txt";
	...
	public void integrateResults() {
		...
		for (Bug bug : bugs) {
			...
			for (String change : results.keySet()) {
				if (revisionTime.containsKey(change) && revisionTime.get(change) < bug.modifyTime)
