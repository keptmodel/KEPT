...
python model/faiss_indexer.py \
   --gpu $cu \
   --data-dpath "./data/"$name \
   --index-name "INDEX_SemanticCodebert_RN_bertoverflow_QD_q256_d256_dim128_cosine_q256_d256_dim128_hunks_token" \
   --partitions 256 &&
python model/ranking.py \
   ...
   --data-dpath "./data/"$name \
   --checkpoint "./data/"$name"/model_SemanticCodebert_"$name"_RN_bertoverflow_QD_q256_d256_dim128_cosine_hunks" \
   --index_name "INDEX_SemanticCodebert_RN_bertoverflow_QD_q256_d256_dim128_cosine_q256_d256_dim128_hunks_token" \
